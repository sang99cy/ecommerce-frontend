...
@NgModule({
  ...
  declarations: [MainComponent, NavbarComponent, ErrorComponent, PageRibbonComponent, ActiveMenuDirective, FooterComponent, NotFoundComponent, ProductManagementComponent, MenuVerticalComponent],
